...
export default function ExpressIcon({ size = 24 }: IGenericIconSvg): ReactElement {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" className="text-lime-700">
      <path
        fill="currentColor"
