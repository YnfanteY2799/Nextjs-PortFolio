...
export default function NextJsIcon({ size = 24 }: IGenericIconSvg): ReactElement {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 512 512" className="text-white">
      <path
        fill="currentColor"
