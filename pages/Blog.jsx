  ...
  return (
    <div className={`container is-max-desktop paddedSearchBar ${show ? "show" : ""}`}>
      <div className="field has-addons">
        ...
        <p className="control">
          <button className="button is-primary" onClick={onButtonClick}>
            {" "}
            Search{" "}
          </button>
        </p>
        ...
        <div className="card-content">
          <div className="media">
            ...
            <div className="media-content">
              <Link href={`/Blogs/${"projectName"}`} className="title is-4">
                {"projectName"}
              </Link>
            </div>
          </div>
          ...
          <div className="content">
            ...
            <hr />
            <p>
              Last Commit at :<time dateTime="2016-1-1">11:09 PM - 1 Jan 2016</time>
            </p>
          </div>
        </div>
    ...
    <>
      ...
      <div>
        ...
        <SearchBar
          ...
          onFilterChange={({ target: { value } }) => setFilteringValue(value)}
          onButtonClick={onClickButton}
          show={searchBarIsOpen}
          handleVisib={() => setSearchBarIsOpen(!searchBarIsOpen)}
        />
